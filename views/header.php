            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <?php if (isset($_SESSION['usuario_id'])): ?>
                        ...
                        // Si es Editor (Rol 1), mostramos Borradores
                        if (in_array(1, $roles)):
                        ?>
                            <li class="nav-item"><a class="nav-link px-3 fw-medium" href="?page=mis-borradores">Borradores</a></li>
                        <?php endif; ?>

                        <?php
                        // Si es Validador (Rol 2), mostramos Revisar
                        if (in_array(2, $roles)):
                        ?>
                            <li class="nav-item"><a class="nav-link px-3 fw-medium text-primary" href="?page=validar-noticias">Revisar Ahora</a></li>
                        <?php endif; ?>
                        ...
                        <li class="nav-item dropdown ms-3">
                            <a class="nav-link p-0" href="#" id="userMenu" role="button" data-bs-toggle="dropdown">
                                <div class="rounded-circle d-flex align-items-center justify-content-center shadow-sm"
                                    style="width: 42px; height: 42px; background-color: #e8f5e9; border: 2px solid #43a047;">
                                    <span class="fw-bold" style="color: #1e3d1a;">
                    ...
                    <?php else: ?>
                        <li class="nav-item ms-lg-4"><a class="nav-link fw-bold text-chipi" href="?page=login">Ingresar</a></li>
                        <li class="nav-item ms-2"><a class="btn btn-chipi rounded-pill px-4 text-white shadow-sm" href="?page=registro">Registrarse</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>

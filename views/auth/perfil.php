                    ...
                    <?php if (mysqli_num_rows($historial) > 0): ?>
                        ...
                        <div class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center border-bottom bg-transparent">
                            <div class="d-flex align-items-center gap-3">
                                <a href="?page=ver-noticia&id=<?= $h['id'] ?>" class="text-decoration-none fs-5" title="Ver contenido">
                                    🔍
                                </a>
                                <div>
                                    <a href="?page=ver-noticia&id=<?= $h['id'] ?>" class="h6 fw-bold mb-0 text-dark text-decoration-none hover-chipi">
                                        <?= e($h['titulo']) ?>
                                    </a>
                                    <br>
                            ...
                            <?php 
                                ...
                                $badge_color = 'bg-warning text-dark'; // Borrador / Para corrección
